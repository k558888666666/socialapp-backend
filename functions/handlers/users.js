const { db, admin, dbstore } = require('../util/admin');
...
exports.login = (req, res) => {
    ...
    firebase.auth().signInWithEmailAndPassword(user.email, user.password)
        ...
        .catch(err => {
            console.error(err);
            return res.status(403).json({ genaral: 'wrong credentails, please try again' })           
        })
}
// add user's details
